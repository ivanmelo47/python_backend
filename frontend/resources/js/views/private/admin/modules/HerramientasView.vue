<template>
    <div class="dashboard-module">
        ...
        <!-- This router-view renders the child routes (Reports, Audit) -->
...
const moduleInfo = computed(() => {
    ...
    // Generate navigation including hidden sidebar items (like Reports/Audit)
...
/**
 * Check if we are exactly at the root tools path
 */
